...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			overlayBgColor: 		'#ac66ca',		// (string) Background color to overlay; inform a hexadecimal value like: #RRGGBB. Where RR, GG, and BB are the hexadecimal values for the red, green, and blue values of the color.
			...
			txtImage:				'Image圖片',	// (string) Specify text "Image"
			txtOf:					'of至',		// (string) Specify text "of"
